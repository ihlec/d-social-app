    ...
    return (
        <div className="app-container">
            ...
            <div className={`main-content ${isSidebarOpen ? 'sidebar-open' : ''}`}>
                ...
                {/* Feed */}
                <Feed /* ... props ... */
                    isLoading={isLoading} topLevelPostIds={displayData.topLevelPostIds} allPostsMap={displayData.allPostsMap} userProfilesMap={displayData.userProfilesMap} onSetReplyingTo={handleSetReplying} onViewProfile={handleViewProfile} onLikePost={likePost} onDislikePost={dislikePost} currentUserState={userState} myIpnsKey={myIpnsKey} onFollowPostAuthor={displayData.allowFollow ? followUser : undefined} footerComponent={showLoadMore ? <div ref={loadMoreRef} className="load-more-trigger">{isLoadingExplore && <p className="loading">Loading More...</p>}</div> : undefined}
                />
            </div>
        </div>
    );
